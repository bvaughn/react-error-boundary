  ...
  return (
    <Box direction="column" gap={4}>
      ...
      <div>
        ...
        <ExternalLink href="https://stackoverflow.com/search?q=react-error-boundary">
          Stack Overflow
        </ExternalLink>{" "}
        or{" "}
        ...
        <ExternalLink href="https://github.com/bvaughn/react-error-boundary/issues?q=is%3Aissue%20state%3Aclosed">
